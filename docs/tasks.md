...
_（**SEQ-20260610-03 MODUX 🔄 8/15 — Phase 1 全收口 ✅ + P2-1 ✅ + P2-2 ✅**（P1-0~P1-4：标题治理 item 5 / DecisionCard item 11·12 / 前台预览 404 修复 item 2〔ADR-160 两叠加 bug〕/ 线路按钮·预设 item 10·6；P2-1：ModListRow 三分区 + page-head 键盘提示收敛 item 4；P2-2：详情状态三元组 + 豆瓣 5 行→1 行 Pill 组 item 7）。下一步 Phase 2 信息密度：**MODUX-P2-3** 键盘流完善——审核台局部挂载共享 `KeyboardShortcuts` 替换原生 keydown + help 浮层（item 1）。）_
