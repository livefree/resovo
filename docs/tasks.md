...
- **Wave 1 进度**（详见 task-queue.md `SEQ-20260527-MOD-WAVE1`）：7/9 完成（含 CHG-351-A）→ 当前下一卡 **CHG-351-B**（packages/admin-ui LinesPanel Props 扩展 / 强制 arch-reviewer Opus + commit trailer）→ CHG-351-C / CHG-352 / CHG-353
