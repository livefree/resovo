...
- **最后更新时间**：2026-06-15 15:00（META-49-B2 ✅ reconcile 裁决核心收口：gather→reconcile→write + M1 方案 A + canonical 加权 + proposals 落表 + conflict_state + interim 退场 + tmdb rescore 补齐 + P1-b passthrough 防回归；下一卡 META-49-C 冲突注入 derive）
