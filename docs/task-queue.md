...
### 任务列表（按执行顺序）
1. CHG-160 — 修复 publish/batchPublish 缺失 ES 同步（状态：⬜ 待开始）
   - 创建时间：2026-03-24 00:00
   - 计划开始：2026-03-24
   - 实际开始：_
   - 完成时间：_
...
2. CHG-161 — 爬虫写入 DB 后触发 ES 异步索引（状态：⬜ 待开始）
   - 创建时间：2026-03-24 00:00
   - 计划开始：CHG-160 完成后
   - 实际开始：_
   - 完成时间：_
...
3. ADMIN-07 — 管理后台视频列表增加来源站点筛选（状态：⬜ 待开始）
   - 创建时间：2026-03-24 00:00
   - 计划开始：CHG-161 完成后
   - 实际开始：_
   - 完成时间：_
...
4. ADMIN-06 — 管理后台内容质量统计视图（状态：⬜ 待开始）
   - 创建时间：2026-03-24 00:00
   - 计划开始：ADMIN-07 完成后
   - 实际开始：_
   - 完成时间：_
...
5. ADMIN-08 — 端对端内容流通 E2E 验证与收口（状态：⬜ 待开始）
   - 创建时间：2026-03-24 00:00
   - 计划开始：ADMIN-06 完成后
   - 实际开始：_
   - 完成时间：_
...
6. PLAYER-10 — 播放页 E2E + DanmakuBar 验证（状态：⬜ 待开始）
   - 创建时间：2026-03-25 00:00
   - 计划开始：VIDEO-07 完成后
   - 实际开始：_
   - 完成时间：_
