...
- **最后更新时间**：2026-04-26 02:15（追加 INFRA-18 = INFRA-17 残留修补草案，⬜ 待开工；触发 Codex 残留复审 1 P2 + 2 P3——§ 7 编号重复 / 鉴权行 cookie 限定 / test:run flaky caveat）
...
12. INFRA-18 — INFRA-17 残留修补：§ 7 编号去重 / 鉴权行 cookie 限定 / test:run flaky caveat（状态：⬜ 待开工）
