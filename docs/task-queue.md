...
| 17 | **CHG-SN-6-RETRO-3-C** | P2-6 AuditClient 521 行拆 cell — 跨包改 packages/admin-ui Props 契约（CHG-DESIGN-12 沉淀范围）；spawn arch-reviewer Opus 评 4 cell Props 契约（actor / actionType / target / payloadSummary）；CLAUDE.md §强制升 Opus 第 1 项触发 | sonnet（cell 实施）+ Opus 子代理（API 契约评审）| 0.2w | 🟢 P2 |
