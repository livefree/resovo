...
13. **CHG-VIR-11** — Phase 4：拆分自动分组建议 + title_en 拼音迁出 + original_language 回填（状态：🔵 拆卡执行中 / 2026-06-03 拆 11-A/11-B/11-C）
    - 创建时间：2026-06-02 19:41
...
13b. **CHG-VIR-11-B** — Phase 4b：拆分自动分组建议 + 拆到已有 video 实施（状态：⬜ 未开始）
    - 创建时间：2026-06-03
...
13c. **CHG-VIR-11-C** — Phase 4c：多语种清洗（migration + title_en 拼音迁出 + original_language 回填 + aliases[] 迁移）（状态：⬜ 未开始）
    - 创建时间：2026-06-03
    - 建议模型：sonnet（数据清洗，规格全部来自 ADR-175 已 Accepted 定档；migration DDL 草案已在 D-175-2）
