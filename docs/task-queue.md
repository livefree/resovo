...
- **状态**：🔄 进行中（3/11 — Phase 0 ✅（0A/0B）+ **Phase 1 进行中**：1A ✅ candidates 端点；下一卡 1B apply-candidate〔硬串行，依赖 1A candidates DTO + 同改 api.ts/route/queries〕）
