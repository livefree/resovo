...
2. **CHG-DESIGN-14** — 改造 `Drawer` + `Modal` 接入 `OverlayBackdrop` ⬜ 待开始
   - **前置**：CHG-DESIGN-13 完成
...
3. **CHG-DESIGN-15** — 改造 `DrawerShell` 接入 `OverlayBackdrop` ⬜ 待开始
   - **前置**：CHG-DESIGN-13 完成
...
4. **CHG-DESIGN-16** — 改造 `CommandPalette` 接入 `OverlayBackdrop` ⬜ 待开始
   - **前置**：CHG-DESIGN-13 完成
...
5. **CHG-DESIGN-17** — grep 防回归脚本 + CI 接入 ⬜ 待开始
