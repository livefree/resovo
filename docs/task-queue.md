...
- **状态**：🟢 进行中（CHG-UX2-01 开工 2026-05-04）
- **创建时间**：2026-05-04
...
- **依赖**：CHG-UX2-01
- **建议模型**：sonnet
- **完成判据**：grep `fontSize: '\d+px'` 在 packages/admin-ui + apps/server-next 命中 = 0

### CHG-UX2-03 · VideoListClient title 列弹性化 + cover 列 poster-md
- **状态**：📝 待开工
- **依赖**：CHG-UX2-02
- **建议模型**：sonnet
- **完成判据**：横向 scrollbar 消失（实测 dt-scroll scrollWidth ≤ clientWidth）；frame 4 角圆角完整可见；视频库 thumb 升级到 48×72
