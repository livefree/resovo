...
- **状态**：🔄 进行中（7/11 — Phase 0 ✅（0A/0B）+ **Phase 1 进行中**：1A ✅ candidates + 1B ✅ apply-candidate + 1C ✅ resolve-event + ids 重扫；余 1D）
