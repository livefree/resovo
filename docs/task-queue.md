...
- **最后更新时间**：2026-04-26 00:36（追加 INFRA-16 = INFRA-10 复审修补草案，⬜ 待开工；触发 Codex 3 finding + 主循环独立确认 F1 是 P1 真实 bug——curl 直连 :4000 绕过浏览器→API 真实链路，验证缺口）
...
10. INFRA-16 — INFRA-10 复审修补：浏览器→API 链路打通 + CORS 403 契约 + source_ip PII（状态：⬜ 待开工）
