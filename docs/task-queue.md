...
- **最后更新时间**：2026-04-26 01:51（追加 INFRA-17 = INFRA-11 复审修补草案，⬜ 待开工；触发 Codex 3 P2 finding + 主循环独立确认全成立——worker service 命名误导 / 浏览器验收口径降级 / docs-format 验收措辞失实）
...
11. INFRA-17 — INFRA-11 复审修补：worker service 命名 / 浏览器验收口径 / docs-format 验收措辞（状态：⬜ 待开工）
