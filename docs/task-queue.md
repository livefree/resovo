...
10. **CHG-VIR-8** — Phase 2b：`identity_candidate` shadow 写入 + 离线生成 job（状态：⬜ 未开始 / **依赖 CHG-VIR-7 ✅ 已解除**；离线 job 复用 `scorePair`/`PairSideInput`，填 externalIds 评估外部 ID 证据）
    - 创建时间：2026-06-02 19:41
