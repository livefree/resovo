...
11-P. **CHG-SN-5-11-PATCH** · 架构清债 6 项（Service 层 + audit + 硬编码色 + segment 语义 + img + zod uuid）— 状态：⬜ 待开始 · **依赖**：CHG-SN-5-11-ADR PASS（✅ 已满足 2026-05-13；ADR-117 Accepted 落 docs/decisions.md，详见 D-117-1..10 偏离清单）
...
11-AUDIT. **CHG-SN-5-CHECKLIST-AUDIT** · ADR 存在性 + Response/Error/Audit checklist 自动化核验机制设计 — 状态：⬜ 待开始 · 独立可并行
