# Resovo（流光）— 开发变更记录归档 · M-SN-2 ~ M-SN-7（2026-04-28 ~ 2026-05-21）

> archived_at: 2026-05-23
> archived_from: docs/changelog.md
> archived_range: CHG-SN-2-21（M-SN-2 milestone 评级 A）~ SEQ-20260521-01 总结（docs 大清理 + manual 工程地基）
> 行号映射（归档前 changelog.md 行号）：40 ~ 13637
> milestone 覆盖：M-SN-2 / M-SN-3 / M-SN-4 / M-SN-5 / M-SN-6 / M-SN-7
> 续档：M-SN-8（CHG-SN-8-01 起）保留在 docs/changelog.md

本文件仅作历史追溯；活跃 changelog 见 `docs/changelog.md`。
M0–M6 期间历史已归档至同目录 `changelog_m0-m6.md`。
