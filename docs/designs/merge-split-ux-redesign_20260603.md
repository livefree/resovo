...
| CHG-VIR-13-B2A | ① MergeComparePanel（N 列矩阵：首列 sticky + 横滚 + 列最小宽度 + 列头 target 单选，§10.4）② MergeResultPreview（含拆分组形态 + 原视频软删明示） | 13-B1 | sonnet | 原 13-B2 拆出 + 增强 #4 + §10.4 |
...
| CHG-VIR-13-I18N | 不变 | B2B/C2/D2 后 | haiku | 依赖更新 |
