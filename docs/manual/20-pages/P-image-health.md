...
**本次更新** (2026-06-19)：新增双 Tab 结构（健康概览 / 图片治理）、破损样本 ImageLightbox 交互、TOP 域行内「切此域」快捷按钮、「近 7 日新增破损」KPI 含 mini 趋势 Spark（SEQ-20260619-01 P1 双 Tab 重构落地；独立趋势卡与 KPI mini spark 同源冗余已收敛移除）
