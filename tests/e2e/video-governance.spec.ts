...
// CHG-E2E-GATE-AUDIT-B2（2026-06-06）：退役「reject path 快捷键拒绝」——v1 冻结 UI 行为
// 漂移（reject 载荷断言失配），同流程由 admin-next moderation 套件覆盖（pending-reject-
// labeled-rejected.spec 等）；happy path 保留（断言仍可满足）。
