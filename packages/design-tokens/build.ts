...
function buildJs(): string {
  const tokens = {
    ...
    adminLayout: { adminShell, adminTable, adminDensity, adminShellZIndex },
  }
...
function buildDts(primitiveVars: Array<[string, string]>, lightVars: Array<[string, string]>): string {
  ...
  return [
    ...
    '  adminLayout: { adminShell: object; adminTable: object; adminDensity: object; adminShellZIndex: object }',
    '}',
