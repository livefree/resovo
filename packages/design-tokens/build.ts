...
function buildLayoutVars(): Array<[string, string]> {
  ...
  // admin-layout — 同 layout 模式（admin 专属，前台 0 消费 by ESLint，CHG-SN-1-07）
...
function buildJs(): string {
  const tokens = {
    ...
    adminLayout: { adminShell, adminTable, adminDensity },
  }
...
function buildDts(primitiveVars: Array<[string, string]>, lightVars: Array<[string, string]>): string {
  ...
  return [
    ...
    '  adminLayout: { adminShell: object; adminTable: object; adminDensity: object }',
    '}',
